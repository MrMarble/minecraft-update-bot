...
import {Changelog, Version, VersionManifest, VersionType} from '../src/types';
import {getChangelogURL} from '../src/helpers/utils';
import dayjs = require('dayjs');
import {JSDOM} from 'jsdom';
import sinon = require('sinon');
import {suite} from 'uvu';
import {getChangelog, getLatestVersion} from '../src/helpers/utils';
...
getLatestVersionSuite.before.each(ctx => {
  ctx.doRequest = sinon.stub(helpers, 'doRequest');
});
